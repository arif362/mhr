...
class Client < ActiveRecord::Base
  ...
  INDUSTRY_LIST = {
      s_proprietorship: 'Sole Proprietorship',
  ...
  COMPANY_SIZE = [1, 2 ,3 ,4 ,5 ,'6-10' ,'11-20' ,'21-30' ,'31-40' ,'41-50' ,'51-100' , 'More than 100']
